  ...
  <div>
    <section>
      ...
      <ul class="list-disc ml-6">
        <li class="my-4">Node.js、ブラウザ、サービスワーカーなど、さまざまなプラットフォームに対応しています。</li>
        <li class="my-4">サーバーレスのサポートもデフォルトで提供されています。</li>
        <li class="my-4">APIルートサポート。</li>
        <li class="my-4">自動的なコード分割と非同期読み込みされるチャンクに対応しています。</li>
        <li class="my-4">
