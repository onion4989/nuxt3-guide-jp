                    ...
                    var o = this,
                      ...
                      r = function () {
                        return n.findIndex(function (e, n) {
                          return (
                            e.innerText.toLowerCase().charAt(0) === t.toLowerCase() && o._history.existsInHistory(n)
                          );
                        });
                      },
                      i = r();
                    ...
                    if (!e.classList.contains("show")) {
                      ...
                      (0, r.fi)(o, n, {
                        ...
                        e.addEventListener(
                          "mouseleave",
                          function o(n) {
                            (n.relatedTarget.closest(t.selector) && n.relatedTarget.closest(t.selector) == e) ||
            ...
            return (
              ...
              u
                ...
                : Object.assign(
                    {},
                    H,
                    (((t = {})[L] = S ? g + "px" : ""), (t[x] = O ? m + "px" : ""), (t.transform = ""), t)
                  )
            );
          }
                      ...
                      return (
                        (e[o] = (function (e, t, o) {
                          var n = N(e),
                            ...
                            s = i[1];
                          return (
                            (a = a || 0), (s = (s || 0) * r), [P, j].indexOf(n) >= 0 ? { x: s, y: a } : { x: a, y: s }
                          );
                        })(o, t.rects, i)),
                        e
                      );
                            ...
                            N(o) === L
                              ? (function (e, t) {
                                  ...
                                  var d = p.reduce(function (t, o) {
                                    return (
                                      (t[o] = re(e, { placement: o, boundary: r, rootBoundary: i, padding: a })[N(o)]),
                                      t
                                    );
                                  }, {});
